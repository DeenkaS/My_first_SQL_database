...
ALTER TABLE adressInformation ADD CONSTRAINT PK_adressInformation PRIMARY KEY (person_ID);
...
ALTER TABLE instrument ADD CONSTRAINT PK_instrument PRIMARY KEY (instructor_ID,student_ID);
...
CREATE TABLE numberOfRentedInstruments (
 instrument_ID INT GENERATED ALWAYS AS IDENTITY NOT NULL,
 student_ID INT GENERATED ALWAYS AS IDENTITY NOT NULL,
 price FLOAT(10) NOT NULL
);

ALTER TABLE numberOfRentedInstruments ADD CONSTRAINT PK_numberOfRentedInstruments PRIMARY KEY (instrument_ID,student_ID);
...
ALTER TABLE attendingStudents ADD CONSTRAINT PK_attending_students PRIMARY KEY (student_ID,lesson_ID);
...
ALTER TABLE adressInformation ADD CONSTRAINT FK_adressInformation_0 FOREIGN KEY (person_ID) REFERENCES person (person_ID);
...
ALTER TABLE numberOfRentedInstruments ADD CONSTRAINT FK_numberOfRentedInstruments_0 FOREIGN KEY (instrument_ID) REFERENCES rentedInstruments (instrument_ID);
ALTER TABLE numberOfRentedInstruments ADD CONSTRAINT FK_numberOfRentedInstruments_1 FOREIGN KEY (student_ID) REFERENCES student (student_ID);
